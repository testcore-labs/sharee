...
define("__VIDEOSDIR__", __FWDIR__."/files/videos/");
define("__FORMAT__", "mp4");

$con;
try {
    $con = new \PDO("pgsql:dbname=sharee;host=localhost", "sharee", "J1IU#GRj44oj");
    $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
}
catch (PDOException $e) {
    echo "connection failed: " . $e->getMessage();
    die("<br><br>fix it lil bro");
}